  ...
  >
    <div class="trezo-tabs products-tabs" id="trezo-tabs">
      ...
      <div class="products-tab-content">
                      ...
                      <div class="flex items-center">
                        ...
                        <div class="ltr:ml-[12px] rtl:mr-[12px]">
                          <RouterLink
                            ...
                            class="font-medium inline-block text-[14px] md:text-[15px] transition-all hover:text-primary-500 mb-px"
                          >
                            Smart Band
                          </RouterLink>
                          <span
        ...
        <div class="tab-pane" v-show="activeTab === 'publishedProducts'">
          <div
            class="trezo-card-header mb-[20px] md:mb-[25px] sm:flex items-center justify-between"
          >
            <div class="trezo-card-title">
        ...
        <div class="tab-pane" v-show="activeTab === 'draftProducts'">
          <div
            class="trezo-card-header mb-[20px] md:mb-[25px] sm:flex items-center justify-between"
          >
            <div class="trezo-card-title">
